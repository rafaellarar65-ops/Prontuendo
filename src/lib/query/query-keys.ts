export const queryKeys = {
  ...
  protocolsList: (params?: { condition?: string; status?: string }) =>
    ['protocols', 'list', params?.condition ?? 'all', params?.status ?? 'all'] as const,
  protocolById: (protocolId: string) => ['protocols', protocolId] as const,
