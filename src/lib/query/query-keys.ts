export const queryKeys = {
  ...
  appointmentsByPatient: (patientId: string) => ['appointments', 'patient', patientId] as const,
  appointmentsByRange: (start: string, end: string) => ['appointments', 'range', start, end] as const,
