...
export class ConfigController {
  ...
  @Post('settings')
  @ApiOperation({ summary: 'Salvar settings globais do tenant' })
  set(@CurrentUser() user: AuthUser, @Body() dto: GenericPayloadDto) {
    return this.service.create(user.tenantId, user.sub, dto.payload);
  }

  @Get('feature-flags')
  @ApiOperation({ summary: 'Listar feature flags' })
  featureFlags(@CurrentUser() user: AuthUser) {
    return this.service.execute('feature-flags', user.tenantId, user.sub, {});
  }
